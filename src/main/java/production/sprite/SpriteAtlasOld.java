...
public class SpriteAtlasOld {
    ...
    public static boolean Init(int atlasWidth, int atlasHeight, int spriteSize) {
        ...
        SpriteAtlasOld.atlasWidth = atlasWidth;
        SpriteAtlasOld.atlasHeight = atlasHeight;
        SpriteAtlasOld.spriteSize = spriteSize;
    ...
    public static final String CLASS = SpriteAtlasOld.class.getSimpleName();
}