 ...
 */
public final class FontAtlasOld {
    ...
    FontAtlasOld(int lineHeight, int base, int atlasWidth, int atlasHeight,
    ...
    public static final String CLASS = FontAtlasOld.class.getSimpleName();
}